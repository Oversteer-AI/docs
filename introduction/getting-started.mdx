...
See the [Fundamentals](https://oversteer.mintlify.app/fundamentals/creating-a-flow) section to learn how to create your first flow and use the rest of the platform!